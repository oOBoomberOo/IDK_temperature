...
#Boots
execute as @s if score @s tmp.totalTemp matches 51.. if entity @s[nbt={Inventory:[{Slot:100b,id:"minecraft:iron_boots"}]}] run scoreboard players set @s tmp.metalArmor1 10
execute as @s if score @s tmp.totalTemp matches ..49 if entity @s[nbt={Inventory:[{Slot:100b,id:"minecraft:iron_boots"}]}] run scoreboard players set @s tmp.metalArmor1 10

execute as @s if score @s tmp.totalTemp matches 51.. if entity @s[nbt={Inventory:[{Slot:100b,id:"minecraft:diamond_boots"}]}] run scoreboard players set @s tmp.metalArmor1 10
execute as @s if score @s tmp.totalTemp matches ..49 if entity @s[nbt={Inventory:[{Slot:100b,id:"minecraft:diamond_boots"}]}] run scoreboard players set @s tmp.metalArmor1 10
