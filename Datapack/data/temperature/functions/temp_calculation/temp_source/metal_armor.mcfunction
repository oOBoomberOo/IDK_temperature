...
#Helmet
execute as @s if entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:iron_helmet"}]}] run scoreboard players set @s tmp.metalArmor4 10
execute as @s if entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:diamond_helmet"}]}] run scoreboard players set @s tmp.metalArmor4 10
execute as @s store result score @s tmp.metalArmor run scoreboard players get @s tmp.metalArmor4

#Chestplate
execute as @s if entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:iron_chestplate"}]}] run scoreboard players set @s tmp.metalArmor3 10
execute as @s if entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:diamond_chestplate"}]}] run scoreboard players set @s tmp.metalArmor3 10


#Leggings
execute as @s if entity @s[nbt={Inventory:[{Slot:101b,id:"minecraft:iron_leggings"}]}] run scoreboard players set @s tmp.metalArmor2 10
execute as @s if entity @s[nbt={Inventory:[{Slot:101b,id:"minecraft:diamond_leggings"}]}] run scoreboard players set @s tmp.metalArmor2 10
