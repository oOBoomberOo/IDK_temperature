...
execute as @s[gamemode=survival,scores={tmp.playerTemp=..20,tmp.coldTime2=1200..}] run function temperature:debuff/cold/soft/2
execute as @s[gamemode=survival,scores={tmp.playerTemp=..15,tmp.coldTime2=1200..}] run function temperature:debuff/cold/soft/3
execute as @s[gamemode=survival,scores={tmp.playerTemp=..15,tmp.coldTime3=1200..}] run function temperature:debuff/cold/soft/4
execute as @s[gamemode=survival,scores={tmp.playerTemp=..10,tmp.coldTime4=1200..}] run function temperature:debuff/cold/soft/5
execute as @s[gamemode=survival,scores={tmp.playerTemp=..5,tmp.coldTime5=1200..}] run function temperature:debuff/cold/soft/6
execute as @s[gamemode=survival,scores={tmp.playerTemp=..0,tmp.coldTime6=1200..}] run function temperature:debuff/cold/soft/7
execute as @s[gamemode=survival,scores={tmp.playerTemp=..-5,tmp.coldTime7=1200..}] run function temperature:debuff/cold/soft/8

execute as @s run scoreboard players operation @s tmp.totalTemp += @s tmp.coldTemp

execute as @s[gamemode=survival,scores={tmp.playerTemp=..25}] run function temperature:debuff/cold/instant/1
