...
execute if score cat.query.time cat.query matches 501..1000 run function temperature:engine/get/time/night
...
scoreboard players operation #cat.query.time bb.calculation /= #1000 bb.variable
