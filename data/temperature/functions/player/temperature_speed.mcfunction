#Default
execute as @s[nbt=!{Dimension:-1}] unless score @s tmp.humidity matches 1.. if score #tmp.bot_timer tmp.variable matches 40.. if score @s tmp.resultTemp matches -14..14 run function temperature:player/temperature
execute as @s[nbt=!{Dimension:-1}] unless score @s tmp.humidity matches 1.. if score #tmp.bot_timer tmp.variable matches 20.. if score @s tmp.resultTemp matches 15..29 run function temperature:player/temperature
execute as @s[nbt=!{Dimension:-1}] unless score @s tmp.humidity matches 1.. if score #tmp.bot_timer tmp.variable matches 20.. if score @s tmp.resultTemp matches -29..-15 run function temperature:player/temperature
execute as @s[nbt=!{Dimension:-1}] unless score @s tmp.humidity matches 1.. if score #tmp.bot_timer tmp.variable matches 10.. if score @s tmp.resultTemp matches 30.. run function temperature:player/temperature
execute as @s[nbt=!{Dimension:-1}] unless score @s tmp.humidity matches 1.. if score #tmp.bot_timer tmp.variable matches 10.. if score @s tmp.resultTemp matches ..-30 run function temperature:player/temperature
