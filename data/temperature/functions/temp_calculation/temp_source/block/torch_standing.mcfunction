...
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sunlight.under_cover] if score @s tmp.tempBiome matches 70.. run scoreboard players set @s tmp.blockTmp -4
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sunlight.under_cover] if score @s tmp.tempBiome matches ..34 run scoreboard players set @s tmp.blockTmp 6
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sunlight.under_cover] if score @s tmp.tempBiome matches 35..69 run scoreboard players set @s tmp.blockTmp 2
