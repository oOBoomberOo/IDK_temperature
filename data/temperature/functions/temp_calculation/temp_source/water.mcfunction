...
execute as @s[scores={tmp.stayInWater=100..}] at @s if block ~ ~ ~ cauldron[level=3] run function temperature:temp_calculation/temp_source/water/cauldron
execute as @s[scores={tmp.stayInWater=100..}] at @s if block ~ ~ ~ cauldron[level=2] run function temperature:temp_calculation/temp_source/water/cauldron
execute as @s[scores={tmp.stayInWater=100..}] at @s if block ~ ~ ~ cauldron[level=1] run function temperature:temp_calculation/temp_source/water/cauldron
