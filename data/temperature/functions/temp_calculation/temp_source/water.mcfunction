...
execute as @s[scores={tmp.stayInWater=100..}] at @s positioned ~ ~0.4 ~ if block ~ ~ ~ water[level=0] unless block ~ ~1 ~ water[level=0] run function temperature:temp_calculation/temp_source/water/water_half
execute as @s[scores={tmp.stayInWater=100..}] at @s positioned ~ ~0.4 ~ if block ~ ~ ~ water[level=0] if block ~ ~1 ~ water[level=0] run function temperature:temp_calculation/temp_source/water/water_full
