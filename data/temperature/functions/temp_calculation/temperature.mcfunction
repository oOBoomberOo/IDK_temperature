...
execute as @s store result score @s tmp.altitude run scoreboard players set @s tmp.altitude 0
execute as @s run tag @s remove tmp.altitude.no_direct_sunlight
execute as @s[nbt={Dimension:0b}] at @s run function temperature:temp_calculation/is_exposed_to_sun
...
execute as @s run function temperature:temp_calculation/temp_source/armor_metal
