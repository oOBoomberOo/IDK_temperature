...
scoreboard players operation #cat.block.temp bb.variable = #cat.block.<id>.temp bb.variable
...
scoreboard players operation #cat.calculated.timer bb.variable += #cat.block.<id>.timer bb.variable
