...
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sky.under_cover,scores={tmp.altitude=45..}] if score @s tmp.tempBiome matches 70.. run scoreboard players set #player.blockTmp tmp.variable -4
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sky.under_cover,scores={tmp.altitude=45..}] if score @s tmp.tempBiome matches ..34 run scoreboard players set #player.blockTmp tmp.variable 6	
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sky.under_cover,scores={tmp.altitude=45..}] if score @s tmp.tempBiome matches 35..69 run scoreboard players set #player.blockTmp tmp.variable 2	
execute as @s[tag=tmp.block.torch_standing,tag=!tmp.sky.under_cover] run scoreboard players set #player.blockTmp tmp.variable 2	
execute as @s[tag=tmp.block.torch_standing,tag=tmp.sky.under_cover,scores={tmp.altitude=..45}] run scoreboard players set #player.blockTmp tmp.variable 2
execute as @s[tag=tmp.block.torch_standing] run scoreboard players operation #player.tempBlock tmp.variable += #player.blockTmp tmp.variable
